    ...
    <div className='flex flex-col items-center'>
      ...
      <div className="w-full flex justify-center items-center mt-20">
        ...
        <div className='w-1/2 h-full relative flex flex-col justify-center pl-32 z-10'>
          ...
          <div className='flex gap-5 mt-6'>
            <NavLink to={"/carte"} >
              <button className='bg-orange text-white px-6 py-3 rounded-3xl'>Je commande!</button>
            </NavLink>
          </div>
        </div>
      </div>
      <div className="w-full flex justify-center items-center mb-20">
        <div className='w-7/12 h-full relative flex flex-col justify-center pl-32 z-10'>
          ...
          <p className='text-justify mb-3'>Nous sommes conscients de l'importance d'une alimentation rigoureuse. C'est pourquoi nous détaillons la composition en macronutriments de chacun de nos plats. Protéines, glucides, lipides... aucune information ne vous échappera.</p>
          ...
          <div className='flex gap-5 mt-6'>
            <NavLink to={"/carte"} >
              <button className='bg-green text-white px-6 py-3 rounded-3xl'>C'est pour moi</button>
            </NavLink>
          </div>
        </div>
